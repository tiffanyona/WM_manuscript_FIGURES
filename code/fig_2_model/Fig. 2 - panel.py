...
df_results.reset_index(inplace=True)
sns.lineplot(x='delays',y='hit',data=df_results, marker='o', hue='state', markeredgewidth = 0.2, palette=['indigo','darkgreen'], ax=b,  errorbar=('ci', 95),linestyle='', legend=False,err_style='bars')
sns.lineplot(x='delays',y='repeat_choice',data=df_results, hue='state',  markeredgewidth = 0.2,palette=['indigo','darkgreen'], marker='o', color='black', errorbar=('ci', 95),legend=False, linestyle='', ax=b2, err_style='bars')
...
df_results['hit'] = df.groupby(groupings)['hit'].mean()
df_results.reset_index(inplace=True)
sns.lineplot(x='delays',y='hit',data=df_results, marker='o', ax=b, markeredgewidth = 0.2,color='black', errorbar=('ci', 95),linestyle='', legend=False,err_style='bars')
sns.lineplot(x='delays',y='repeat_choice',data=df_results, marker='o', markeredgewidth = 0.2,color='black', errorbar=('ci', 95),legend=False, linestyle='', ax=b2, err_style='bars')
...
df_results.reset_index(inplace=True)
sns.lineplot(x='delays',y='hit',data=df_results, hue='state', marker='', ax=b, palette=['indigo','darkgreen'],  errorbar=('ci', 95),legend=False,err_style=None)
sns.lineplot(x='delays',y='repeat_choice', hue='state', data=df_results, palette=['indigo','darkgreen'], marker='',  errorbar=('ci', 95),ax=b2, err_style=None)
b.set_ylim(0.4,1)
...
df_results['repeat_choice'] = 0.5* df_model.loc[(df_model['repeat_choice_side']==1)].groupby(groupings)['choices'].count()/df_model.loc[df_model.choices == -1].groupby(groupings)['choices'].count() + 0.5*df_model.loc[(df_model['repeat_choice_side']==2)].groupby(groupings)['choices'].count()/df_model.loc[(df_model.choices == 1)].groupby(groupings)['choices'].count()
df_results.reset_index(inplace=True)
sns.lineplot(x='delays',y='hit',data=df_results, marker='', ax=b, color='black',  errorbar=('ci', 95),legend=False,err_style=None)
sns.lineplot(x='delays',y='repeat_choice', data=df_results, color='black', marker='',  errorbar=('ci', 95),ax=b2, err_style=None)
b2.set_ylim(0.4,1)
...
sns.stripplot(x='model',y='substracted', data=full_fit, jitter=0.3,size=2, order=["all",'12','9','10','11'], hue='model', palette = color_list, legend=False, edgecolor='white', linewidth=0.1, ax=panel)
sns.violinplot(x='model',y='substracted', data=full_fit, saturation=0.7, order=["all",'12','9','10','11'], hue='model', palette = 'copper', legend=False, linewidth=0, width = 0.5, ax=panel)
sns.violinplot(x='model',y='substracted', data=full_fit, order=["all",'12','9','10','11'], hue='model', palette = 'copper', legend=False, linewidth=1.5, width = 0.5, ax=panel )
...
df_results['repeat_choice'] = 0.5* df.loc[(df['repeat_choice_side']==1)].groupby(groupings)['choices'].count()/df.loc[df.choices == -1].groupby(groupings)['choices'].count() + 0.5*df.loc[(df['repeat_choice_side']==2)].groupby(groupings)['choices'].count()/df.loc[(df.choices == 1)].groupby(groupings)['choices'].count()
df_results.reset_index(inplace=True)
sns.lineplot(x='delays',y='hit',data=df_results, marker='o',  markeredgewidth = 0.1, ax=c, color='black', errorbar=('ci', 95),linestyle='', legend=False,err_style='bars')
sns.lineplot(x='delays',y='repeat_choice',data=df_results, marker='o',  markeredgewidth = 0.1,color='black', errorbar=('ci', 95),legend=False, linestyle='', ax=c2, err_style='bars')
...
# for model, color, label in zip(['9','10','11','12'],color_list,['DW Beta^X0_rep','DW Beta^mub_rep','DW both','DW']):
    ...
    sns.lineplot(x='delays',y='hit',data=df_results, marker='', ax=c, color=color, errorbar=('ci', 95),legend=False,err_style=None)
    sns.lineplot(x='delays',y='repeat_choice', data=df_results, color=color, marker='',  errorbar=('ci', 95),ax=c2, err_style=None)
