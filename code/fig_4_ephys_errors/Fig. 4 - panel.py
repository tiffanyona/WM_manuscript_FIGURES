...
fig.text(0.01, 0.97, 'a', fontsize=10, fontweight='bold', va='top')  # j1 row0
fig.text(0.01, 0.87, 'b', fontsize=10, fontweight='bold', va='top')  # j2 row1
fig.text(0.01, 0.77, 'c', fontsize=10, fontweight='bold', va='top')  # j0 row2
fig.text(0.52, 0.97, 'd', fontsize=10, fontweight='bold', va='top')  # g2 row0
fig.text(0.52, 0.87, 'e', fontsize=10, fontweight='bold', va='top')  # j3 row1
...
fig.text(0.01, 0.36, 'i', fontsize=10, fontweight='bold', va='top')  # i_heat row6
fig.text(0.52, 0.36, 'j', fontsize=10, fontweight='bold', va='top')  # j_heat row6

# ===========================================================================
# Panels a / b / c — decoder plots
# ===========================================================================
...
panel.text(0.0, -2.8, 'Correct',   ha='center', fontsize=6, color='darkgreen')
panel.text(1.0, -2.8, 'Incorrect', ha='center', fontsize=6, color='crimson')
...
# ===========================================================================
# Panels g / h — single trial decoder examples
# ===========================================================================
...
df_t       = pd.read_csv(path_repl + 'df_'      + str(T) + '_' + filename, index_col=0)
big_data   = pd.read_csv(path_repl + '/convolve_'+ str(T) + '_' + filename, index_col=0)
plots.single_trial_with_decoder(df_t, df_decoder, big_data, filename, T, panels=[a1,a2,a3])
...
df_t       = pd.read_csv(path_repl + 'df_'      + str(T) + '_' + filename, index_col=0)
big_data   = pd.read_csv(path_repl + 'convolve_' + str(T) + '_' + filename, index_col=0)
plots.single_trial_with_decoder(df_t, df_decoder, big_data, filename, T,
...
df = pd.read_csv(path_rev + 'log_odds_single_trial_errors_normalized.csv', index_col=0)
