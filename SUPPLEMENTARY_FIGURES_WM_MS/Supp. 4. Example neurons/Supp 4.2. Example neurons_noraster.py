...
save_path = 'G:/Mi unidad/WORKING_MEMORY/PAPER/WM_manuscript_FIGURES/SUPPLEMENTARY_FIGURES_WM_MS/Supp. 4. Example neurons'
...
e1 = fig.add_subplot(gs[1, 0:2])
f1 = fig.add_subplot(gs[1, 2:4])
g1 = fig.add_subplot(gs[1, 4:6])
h1 = fig.add_subplot(gs[1, 6:8])
i1 = fig.add_subplot(gs[2, 0:2])
j1 = fig.add_subplot(gs[2, 2:4])
k1 = fig.add_subplot(gs[2, 4:6])
l1 = fig.add_subplot(gs[2, 6:8])
m1 = fig.add_subplot(gs[3, 0:2])
n1 = fig.add_subplot(gs[3, 2:4])
o1 = fig.add_subplot(gs[3, 4:6])
p1 = fig.add_subplot(gs[3, 6:8])
...
def convolveandplot(df, lower_plot, variable='reward_side', cluster_id = 153, delay = 10, labels=['Correct right stimulus','Correct left stimulus'],
...
j = convolveandplot(temp_df, a1, variable='reward_side', cluster_id = cluster_id, delay = delay, j=j)
...
j=1
temp_df = df.loc[(df.WM_roll >0.6)&(df.hit ==1)]
j = convolveandplot(temp_df, b1, variable='reward_side', cluster_id = cluster_id, delay = delay, j=j)
...
j=1
temp_df = df.loc[(df.WM_roll >0.6)&(df.hit ==1)]
j = convolveandplot(temp_df, c1, variable='reward_side', cluster_id = cluster_id, delay = delay, j=j)
...
j=1
temp_df = df.loc[(df.WM_roll >0.6)&(df.hit ==1)]
j = convolveandplot(temp_df, d1, variable='reward_side', cluster_id = cluster_id, delay = delay, j=j)
...
j=1
temp_df = df.loc[(df.WM_roll >0.6)&(df.hit ==1)]
j = convolveandplot(temp_df, e1, variable='reward_side', cluster_id = cluster_id, delay = delay, j=j)
...
j=1
temp_df = df.loc[(df.WM_roll >0.6)&(df.hit ==1)]
j = convolveandplot(temp_df, f1, variable='reward_side', cluster_id = cluster_id, delay = delay, j=j)
...
# j=1
# temp_df = df.loc[(df.WM_roll >0.6)&(df.hit ==1)]
# j = convolveandplot(temp_df, g1, variable='reward_side', cluster_id = cluster_id, delay = delay, j=j)
# g1.set_title(file_name)

# file_name = '/E19_2022-01-14_14-42-13_neuron_2_delay_10'
# df = pd.read_csv(path+file_name+'.csv', index_col=0)
...
# j=1
# temp_df = df.loc[(df.WM_roll >0.6)&(df.hit ==1)]
# j = convolveandplot(temp_df, i1, variable='reward_side', cluster_id = cluster_id, delay = delay, j=j)
# g1.set_title(file_name)

# file_name = 'E11_2021-05-26_12-20-58_neuron_112_delay_3'
# df = pd.read_csv(path+file_name+'.csv', index_col=0)
...
file_name = 'E19_2022-01-14_14-42-13_neuron_68_delay_10'
df = pd.read_csv(path+file_name+'.csv', index_col=0)
...
j=1
temp_df = df.loc[(df.WM_roll >0.6)&(df.hit ==1)]
j = convolveandplot(temp_df, h1, variable='reward_side', cluster_id = cluster_id, delay = delay, j=j)
...
# j=1
# temp_df = df.loc[(df.WM_roll >0.6)&(df.hit ==1)]
# j = convolveandplot(temp_df, j1,  variable='reward_side', cluster_id = cluster_id, delay = delay, j=j)
...
# j=1
# temp_df = df.loc[(df.WM_roll >0.6)&(df.hit ==1)]
# j = convolveandplot(temp_df, k1, variable='reward_side', cluster_id = cluster_id, delay = delay, j=j)
...
# j=1
# temp_df = df.loc[(df.WM_roll >0.6)&(df.hit ==1)]
# j = convolveandplot(temp_df, l1, variable='reward_side', cluster_id = cluster_id, delay = delay, j=j, label=True)
...
# j=1
# temp_df = df.loc[(df.WM_roll >0.6)&(df.hit ==1)]
# j = convolveandplot(temp_df, m1,variable='reward_side', cluster_id = cluster_id, delay = delay, j=j, label=True)
...
# j=1
# temp_df = df.loc[(df.WM_roll >0.6)&(df.hit ==1)]
# j = convolveandplot(temp_df, n1, variable='reward_side', cluster_id = cluster_id, delay = delay, j=j, label=True)
...
# j=1
# temp_df = df.loc[(df.WM_roll >0.6)&(df.hit ==1)]
# j = convolveandplot(temp_df, o1, variable='reward_side', cluster_id = cluster_id, delay = delay, j=j, label=True)

# -----------------############################## C Panel - Single neuron example ############-----------------------

file_name = 'E22_2022-01-14_16-50-37_neuron_47'
df = pd.read_csv(path+file_name+'.csv', index_col=0)
...
j=1
temp_df = df.loc[(df.WM_roll >0.6)&(df.hit ==1)]
j = convolveandplot(temp_df, p1, variable='reward_side', cluster_id = cluster_id, delay = delay, j=j, label=True)
...
sns.despine()
plt.savefig(save_path+'/Supp 4.2. Example neurons_V2.svg', bbox_inches='tight',dpi=300)
plt.savefig(save_path+'/Supp 4.2. Example neurons_V2.png', bbox_inches='tight',dpi=300)
