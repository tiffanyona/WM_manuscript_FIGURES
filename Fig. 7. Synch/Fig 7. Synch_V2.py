...
panel.set_xlabel('Autocorrelogram#')
...
panel.hlines(xmin=3.5, xmax=15.6, y=0.015, linewidth=2)
...
panel.hlines(xmin=2, xmax=100, y=1, linestyle=':')
panel.vlines(ymin=0, ymax=1.6, x=4.4, color='crimson')
panel.fill_between(x, y_min, y_max, color='gray', alpha=0.3, label='Error Band')

panel.tick_params(axis="both", which='both',direction="out")
panel.set_title('PSD ratio', fontsize=7)
panel.set_xlabel('Frequency (Hz)')
